defmodule TdAuthWeb.UserControllerTest do
  ...
  @create_attrs %{password: "some password_hash", user_name: "some user_name", is_admin: false, email: "some@email.com", groups: [%{name: "Group"}]}
  @create_second_attrs %{password: "some password_hash", user_name: "some user_name 2", is_admin: false}
  @update_attrs %{password: "some updated password_hash", user_name: "some updated user_name", groups: [%{name: "GroupNew"}]}
